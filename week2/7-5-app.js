import { getAllProducts, searchProducts, getProductsByCategory } from './7-1-product.js';
import { addToCart, getCartItems, getCartTotal, updateQuantity, removeFromCart } from './7-2-cart.js';
import { processPayment } from './7-4-payment.js';
