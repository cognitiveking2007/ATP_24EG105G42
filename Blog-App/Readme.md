...
https://blog-app-4eug.onrender.com
...
I learned authentication, role-based access control, API integration, state management, protected routes, file uploads, deployment using Vercel and Render,
and handling production issues like CORS and environment variables.
